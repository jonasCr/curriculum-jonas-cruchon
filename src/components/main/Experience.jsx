...
const Experience = () => {
  return (
    <div className='md:p-14 p-8'>
      <h2 className='mb-3 md:mb-5 md:text-4xl text-3xl font-extrabold uppercase'>Experience</h2>
      {
        [0,1,2,3,4,5].map((item,key)=> (
          <div className='md:mb-16 mb-8' key={key}>
            <div className='md:flex flex-auto block'>
              <div>
                ...
                <p className='font-light text-primary-700 mt-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, cumque veritatis officia cupiditate beatae exercitationem. Sapiente iste hic nulla illum! Autem nostrum error sint maiores id ab recusandae, tempore cupiditate.</p>
              </div>
